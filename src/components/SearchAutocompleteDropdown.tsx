...
export const SearchAutocompleteDropdown: React.FC<SearchAutocompleteDropdownProps> = ({
  ...
  return (
    <div 
      ...
      className="absolute top-full left-0 right-0 mt-1.5 bg-white/95 dark:bg-[#141414]/95 backdrop-blur-xl border border-slate-200/90 dark:border-white/10 rounded-2xl shadow-2xl overflow-hidden z-50 animate-fadeIn divide-y divide-slate-100 dark:divide-white/5"
    >
